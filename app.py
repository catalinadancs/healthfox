...
@app.route('/rezultate.php')
def rezultat():
    prediction = request.args.get('prediction')
    return render_template('rezultate.php', prediction=prediction)


@app.route('/predictie_user.html', methods=['GET', 'POST'])
def predictie_user():
    prediction = None  # Inițializare variabilă prediction
    ...
    if request.method == 'POST':
        ...
        # Returnați rezultatul către pagina de rezultate
        # return redirect(url_for('predictie_user.php', prediction=prediction))
        # Returnați rezultatul către aceeași pagină
        return str(prediction)

    return render_template('predictie_user.html', prediction=prediction)
